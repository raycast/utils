 ...
 * ```
 */
export class AsanaOAuthService extends OAuthService {
 ...
 * ```
 */
export class JiraOAuthService extends OAuthService {
  constructor(options: ClientConstructor) {
    super({
      client: new OAuth.PKCEClient({
        redirectMethod: OAuth.RedirectMethod.Web,
 ...
 * ```
 */
export class SlackOAuthService extends OAuthService {
  constructor(options: ClientConstructor) {
    super({
      client: new OAuth.PKCEClient({
        redirectMethod: OAuth.RedirectMethod.Web,
