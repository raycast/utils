...
export class OAuthService implements OAuthServiceOptions {
  ...
  public static asana(options: ProviderWithDefaultClientOptions) {
    return new OAuthService({
      client: new OAuth.PKCEClient({
        ...
        providerName: options.providerName ?? "Asana",
        ...
        description: options.description ?? "Connect your Asana account",
      }),
  ...
  public static github(options: ProviderWithDefaultClientOptions) {
    return new OAuthService({
      client: new OAuth.PKCEClient({
        redirectMethod: OAuth.RedirectMethod.Web,
        providerName: options.providerName ?? "GitHub",
        providerIcon: {
        ...
        description: options.description ?? "Connect your GitHub account",
      }),
  ...
  public static google(options: ProviderOptions) {
    return new OAuthService({
      client: new OAuth.PKCEClient({
        ...
        description: options.description ?? "Connect your Google account",
      }),
  ...
  public static jira(options: ProviderOptions) {
    return new OAuthService({
      client: new OAuth.PKCEClient({
        redirectMethod: OAuth.RedirectMethod.Web,
        providerName: options.providerName ?? "Jira",
        providerIcon: `data:image/svg+xml,${encodeURIComponent(
        ...
        description: options.description ?? "Connect your Jira account",
      }),
      clientId: options.clientId,
  ...
  public static linear(options: ProviderWithDefaultClientOptions) {
    return new OAuthService({
      client: new OAuth.PKCEClient({
        redirectMethod: OAuth.RedirectMethod.Web,
        providerName: options.providerName ?? "Linear",
        providerIcon: {
          source: {
        ...
        description: options.description ?? "Connect your Linear account",
      }),
  ...
  public static slack(options: ProviderWithDefaultClientOptions) {
    return new OAuthService({
      client: new OAuth.PKCEClient({
        redirectMethod: OAuth.RedirectMethod.Web,
        providerName: options.providerName ?? "Slack",
        providerIcon: `data:image/svg+xml,${encodeURIComponent(
        ...
        description: options.description ?? "Connect your Slack account",
      }),
  ...
  public static zoom(options: ProviderOptions) {
    return new OAuthService({
      client: new OAuth.PKCEClient({
        redirectMethod: OAuth.RedirectMethod.Web,
        providerName: options.providerName ?? "Zoom",
        providerIcon: `data:image/svg+xml,${encodeURIComponent(
        ...
        description: options.description ?? "Connect your Zoom account",
      }),
      clientId: options.clientId,
